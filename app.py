...
#catalogo = Catalogo(host='192.168.100.7', user='root', password='elena', database='worldviajesanda')
#catalogo = Catalogo(host='192.168.1.98', user='root', password='', database='worldviajes')
catalogo = Catalogo(host='192.168.1.98', user='root', password='', database='worldviajess')
